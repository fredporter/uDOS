...
class StoryHandler:
    ...
    def __init__(self, components: Dict[str, Any]):
        ...
        # Story system paths
        self.adventures_dir = PATHS.MEMORY_UCODE_ADVENTURES
        self.state_dir = PATHS.MEMORY_WORKFLOWS_STATE
        self.checkpoints_dir = PATHS.MEMORY_WORKFLOWS_CHECKPOINTS
    ...
    def _pause_adventure(self) -> str:
        ...
        self.story_state["pause_time"] = datetime.now(timezone.utc).isoformat()
    ...
    def _resume_adventure(self) -> str:
        ...
        self.story_state["resume_time"] = datetime.now(timezone.utc).isoformat()
