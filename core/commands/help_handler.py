...
class HelpHandler(BaseCommandHandler, HandlerLoggingMixin, InteractiveMenuMixin):
    ...
    COMMANDS = {
        ...
        "RUN": {
            "description": "Execute TS markdown runtime script and TS-backed data ops",
            "usage": "RUN <file> [section_id] | RUN PARSE <file> | RUN DATA ...",
            "example": "RUN core/examples/sample.md intro",
            "notes": "Executes a markdown script or lists parsed sections",
            "category": "Advanced",
            "syntax": "RUN <file> [section_id] | RUN PARSE <file> | RUN DATA <LIST|VALIDATE|BUILD|REGEN> ...",
        },
    }
