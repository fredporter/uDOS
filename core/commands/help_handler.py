...
class HelpHandler(BaseCommandHandler, HandlerLoggingMixin, InteractiveMenuMixin):
    ...
    COMMANDS = {
        ...
        "PROVIDER": {
            "description": "Manage AI/service providers (deprecated: use SETUP instead)",
            "usage": "PROVIDER [LIST|STATUS <id>|ENABLE <id>|DISABLE <id>]",
            "example": "PROVIDER LIST or PROVIDER STATUS github",
            "notes": "Use 'SETUP <provider>' instead (SETUP github, SETUP ollama, etc.)",
            "category": "Advanced",
            "syntax": "PROVIDER <LIST|STATUS|ENABLE|DISABLE> [<id>]",
        },
        "WIZARD": {
        ...
        "WORKSPACE": {
            "description": "Workspace-aware filesystem operations",
            "usage": "WORKSPACE <LIST|READ|WRITE|DELETE|INFO|HELP> @workspace[/path]",
            "example": "WORKSPACE LIST @sandbox",
            "notes": "Use @workspace references like @vault, @inbox, @shared",
            "category": "Advanced",
            "syntax": "WORKSPACE <LIST|READ|WRITE|DELETE|INFO|HELP> @workspace[/path]",
        },
        "TAG": {
            "description": "Tag discovery over workspace files",
            "usage": "TAG <LIST @workspace|FIND <tag...>>",
            "example": "TAG FIND roadmap todo",
            "notes": "Lists extracted tags or finds files by tag",
            "category": "Advanced",
            "syntax": "TAG <LIST|FIND> ...",
        },
        "LOCATION": {
            "description": "Grid location tagging for workspace files",
            "usage": "LOCATION <TAG @workspace/file.md L###-AA00|FIND L###-AA00>",
            "example": "LOCATION TAG @sandbox/story.md L300-AB15",
            "notes": "Attach grid IDs to files and query by location",
            "category": "Advanced",
            "syntax": "LOCATION <TAG|FIND> ...",
        },
        "RUN": {
