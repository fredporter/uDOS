...
When to use this vs unified_logging:
    - Use logging_manager for Core TUI, offline-first, file-based logs.
    - Use unified_logging only when you need cross-system aggregation
      across Core/Wizard/Goblin/Extensions.
