"""Dev Mode tool workspace service."""
...
class DevModeToolWorkspaceService:
    ...
    def __init__(self):
        ...
        self.logger = get_logger("dev-mode-tool-workspace-service")
...
# Global singleton
VibeWorkspaceService = DevModeToolWorkspaceService

_workspace_service: Optional[DevModeToolWorkspaceService] = None


def get_workspace_service() -> DevModeToolWorkspaceService:
    """Get or create the global workspace service."""
    global _workspace_service
    if _workspace_service is None:
        _workspace_service = DevModeToolWorkspaceService()
