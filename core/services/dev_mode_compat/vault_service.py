...
class DevModeToolVaultService:
    ...
    def __init__(self):
        ...
        self.logger = get_logger("dev-mode-tool-vault-service")
...
# Global singleton
VibeVaultService = DevModeToolVaultService

_vault_service: Optional[DevModeToolVaultService] = None


def get_vault_service() -> DevModeToolVaultService:
    """Get or create the global vault service."""
    global _vault_service
    if _vault_service is None:
        _vault_service = DevModeToolVaultService()
