"""Dev Mode tool automation service."""
...
class DevModeToolAutomationService:
    ...
    def __init__(self):
        ...
        self.logger = get_logger("dev-mode-tool-automation-service")
...
# Global singleton
VibeWizardService = DevModeToolAutomationService

_wizard_service: Optional[DevModeToolAutomationService] = None


def get_wizard_service() -> DevModeToolAutomationService:
    """Get or create the global wizard service."""
    global _wizard_service
    if _wizard_service is None:
        _wizard_service = DevModeToolAutomationService()
