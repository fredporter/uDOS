"""Dev Mode tool sync orchestrator."""
...
logger = get_logger("dev-mode-tool-sync-service")


class DevModeToolSyncService:
...
# Singleton instance
VibeSyncService = DevModeToolSyncService

_sync_service: Optional[DevModeToolSyncService] = None


def get_sync_service() -> DevModeToolSyncService:
    """Get or create sync service singleton."""
    global _sync_service
    if _sync_service is None:
        _sync_service = DevModeToolSyncService()
