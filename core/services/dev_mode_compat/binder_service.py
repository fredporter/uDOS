...
class DevModeToolBinderService:
    ...
    def __init__(self):
        ...
        self.logger = get_logger("dev-mode-tool-binder-service")
...
VibeBinderService = DevModeToolBinderService


def get_binder_service() -> DevModeToolBinderService:
    """Get or create the global binder service."""
    global _binder_service_instance
    if _binder_service_instance is None:
        _binder_service_instance = DevModeToolBinderService()
