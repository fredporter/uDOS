...
class KnowledgeMetrics:
    ...
    def __init__(self, knowledge_path: str = "knowledge"):
        ...
        self.report_path = Path("memory/system/knowledge-quality-report.json")
        self.history_path = Path("memory/system/knowledge-quality-history.json")
...
"""
        ...
        # Save HTML report
        html_path = Path("memory/system/knowledge-quality-dashboard.html")
