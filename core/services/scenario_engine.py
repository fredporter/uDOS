...
from core.services.inventory_service import ItemCategory
...
class ScenarioEngine:
    ...
    def __init__(self, scenario_service, xp_service=None,
                 inventory_service=None, survival_service=None):
        """
