...
Rounds 3‑10 rely on the Hotkey Center as the canonical source of truth for TAB, F1‑F8, and history bindings so every key-binding change is visible to automation scripts before they retrain the hot reload/self-heal loops.
