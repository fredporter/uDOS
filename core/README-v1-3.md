...
- When ready, the renderer should export to `vault/_site/<theme>/...` while logging missions, jobs, and contributions in the vault SQLite (`docs/Vault-Contract.md`, `docs/Mission-Job-Schema.md`, `docs/Contributions-Contract.md`).
