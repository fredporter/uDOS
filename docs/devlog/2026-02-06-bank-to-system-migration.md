...
Migrated from `memory/bank/` structure to cleaner separation:
...
```bash
memory/bank/system/          → memory/system/
memory/bank/locations/       → vault-md/bank/locations/
memory/bank/spatial/         → vault-md/bank/spatial/
memory/bank/private/         → memory/private/
memory/bank/binders/         → vault-md/bank/binders/
```
...
**Old paths remain for backwards compatibility:**
- `memory/bank/` still exists but deprecated
...
5. ⏳ Remove `memory/bank/` after verification
