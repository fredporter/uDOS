...
When you run `./Launch-Dev-Mode.command`, the Wizard Server automatically starts:
...
If port 8765 is in use, modify `WIZARD_PORT` in `Launch-Dev-Mode.command`:
...
- [Dev Mode Launcher](../Launch-Dev-Mode.command)
