...
| `dev/docs/specs/DEV-WORKSPACE-SPEC.md` | `implemented` | `dev/docs/specs/DEV-WORKSPACE-SPEC.md`, `wizard/services/dev_mode_service.py`, `wizard/services/dev_extension_service.py`, `wizard/routes/dev_routes.py` | Dev Mode is now explicitly defined as a Wizard-gated `/dev/` extension lane with an explicit `@dev` workspace contract and tracked sync boundary. |
