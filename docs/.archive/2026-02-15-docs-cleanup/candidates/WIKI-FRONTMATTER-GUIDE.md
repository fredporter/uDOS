...
Location tags are indexed by [Spatial Filesystem](Spatial-Workspace-Filesystem.md) for discovery.
...
- [SPATIAL-FILESYSTEM.md](Spatial-Workspace-Filesystem.md) — Location tagging reference
