...
### 🔸 Output:
```
/uOS/scripts/ulogger.sh: line 28: log: command not found
```
...
### 🔸 Output:
```
/uOS/scripts/ulogger.sh: line 28: restart: command not found
```
...
### 🔸 Output:
```
/uOS/scripts/ulogger.sh: line 28: dir: command not found
```
