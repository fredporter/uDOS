...
class ArchiveMigration:
    ...
    def migrate_system_archived(self):
        ...
        dest = PATHS.MEMORY_WORKFLOWS_MISSIONS / ".archive" / "completed"
        ...
        workflow_dest = PATHS.MEMORY_WORKFLOWS / ".archive" / "completed"
    ...
    def migrate_system_backup(self):
        ...
        dest = PATHS.MEMORY_SYSTEM_USER / ".archive" / "backups"
    ...
    def migrate_workflows_archived(self):
        ...
        source = PATHS.MEMORY_WORKFLOWS / ".archive" / "archived"
        dest = PATHS.MEMORY_WORKFLOWS / ".archive" / "completed"
    ...
    def cleanup_old_folders(self):
        ...
        folders_to_check = [
            ...
            PATHS.MEMORY_WORKFLOWS / ".archive" / "archived"
        ]
