# uCODE MODULAR COMMAND REFERENCE MANUAL v1.4.0
...
```ascii
    ...
    uCODE Command Reference v1.4.0
    ═══════════════════════════════════════════════════
```

**Version**: 1.4.0
**Date**: August 25, 2025
**Part Number**: uCODE-REF-001-v140
**Status**: Production Ready

The essential command set for uCODE, the native programming language for uSCRIPT operations on devices running uDOS v1.4.0 with three-mode display system, five-tier role hierarchy, data separation architecture, and enhanced development environment.
...
```ucode
~ Role operations (8-Role System v1.4.0)
...
```ucode
~ Sandbox workspace operations (v1.4.0)
