# Changelog Archive - v1.1.x Series

This archive contains the complete changelog for uDOS v1.1.0 through v1.1.18 releases.

**Note**: This content has been archived from the main CHANGELOG.md to keep the active changelog focused on v1.2.x and newer releases.
