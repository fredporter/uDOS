...
**Related Documents:**
- [Diagram Format Compatibility Brief](./2025-12-02_diagram_format_compatibility.md) - GitHub vs Typora format analysis
- [ASCII Diagram Library Examples](../roadmap/graphics1.md) - 25 panel-style diagrams with block shading
- [ASCII Diagram Library Examples](../roadmap/graphics2.md) - 25 plain ASCII diagrams (no block characters)
...
```python
# Current (ASCII only - chunky style)
BOX_CHARS = {
    'tl': '+', 'tr': '+', 'bl': '+', 'br': '+',
    'h': '-', 'v': '|', 'x': '+'
}

# Refined (Unicode box-drawing - clean style)
BOX_CHARS_UNICODE = {
    'tl': '┌', 'tr': '┐', 'bl': '└', 'br': '┘',
    'h': '─', 'v': '│', 'x': '┼',
    'lt': '├', 'rt': '┤', 'tt': '┬', 'bt': '┴'
...
# Two distinct house styles available:
# Style 1: Plain ASCII (graphics2.md) - Maximum compatibility
# Style 2: Block shading (graphics1.md) - Visual hierarchy with █▓▒░
