...
# Or run TUI (command-line interface)
python -m core.tui

# Or build Tauri app (desktop GUI)
...
```bash
git clone --depth=1 https://github.com/fredporter/uDOS.git
pip install -r requirements.txt
```
...
Contributor setup with full git history.
