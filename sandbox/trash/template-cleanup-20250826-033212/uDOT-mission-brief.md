...
**Legacy Save:** {{input:save_as_legacy|boolean|default:false}}
...
- **Final Outcome:** {{completion_outcome}}
...
- **Legacy Category:** {{input:legacy_category|enum:achievement,knowledge,innovation,improvement|default:achievement}}
- **Legacy Value:** {{input:legacy_value|textarea}}
- **Future Applications:** {{input:future_applications|textarea}}
- **Archive Location:** uMEMORY/legacy/missions/{{mission_name|slugify}}/
{{/if}}
{{/if}}
