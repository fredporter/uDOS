...
**User Role**: developer  
**Generated**: 2025-07-18 13:35:12 UTC
...
# Generated from template: cloud-installer.md
...
print_header() {
    ...
    echo "║              Generated: 2025-07-18 13:35:12 UTC                           ║"
    echo "╚══════════════════════════════════════════════════════════════════╝"
    echo -e "${NC}"
}
...
- `developer` - uDOS user role
- `true` - Chester AI companion (true/false)
