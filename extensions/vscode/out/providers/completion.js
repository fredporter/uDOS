...
exports.UPYCompletionProvider = void 0;
const vscode = __importStar(require("vscode"));
class UPYCompletionProvider {
    constructor() {
        this.commands = [
    ...
    getWorkflowPropertyCompletions() {
    ...
    getCheckpointPropertyCompletions() {
...
exports.UPYCompletionProvider = UPYCompletionProvider;
