    ...
    try:
        ...
        if platform.system() == "Darwin":
            ...
            tell application "Terminal"
                activate
                do script "cd {udos_path} && UV_PROJECT_ENVIRONMENT=.venv ./bin/Launch-uCODE.sh core -c L"
            end tell
            """
            ...
            for term in terminals:
                try:
                    cmd = f"cd {udos_path} && UV_PROJECT_ENVIRONMENT=.venv ./bin/Launch-uCODE.sh core -c L"
