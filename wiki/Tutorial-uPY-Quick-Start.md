...
Learn the new uPY v1.1.9+ syntax through hands-on examples!
...
Create a new file `sandbox/ucode/my_first.upy`:
...
**Run it:**
```bash
./start_udos.sh sandbox/ucode/my_first.upy
```
...
**Create `sandbox/ucode/character_demo.upy`:**
...
**Run it:**
```bash
./start_udos.sh sandbox/ucode/character_demo.upy
```
