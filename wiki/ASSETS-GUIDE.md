# uDOS Assets System Guide

**Overview:** Shared asset management for extensions
...
> **🎨 See Also**: [Style Guide](Style-Guide.md) - Design conventions, CSS frameworks, typography, and color systems
...
## Web Extension Shared Components

### Visual Identity System

uDOS web extensions use a unified visual identity based on the **Monaspace** font family and **Synthwave DOS** color palette.
...
```css
:root {
    --font-neon: 'Monaspace Neon', monospace;
    --font-argon: 'Monaspace Argon', monospace;
    --font-xenon: 'Monaspace Xenon', monospace;
    --font-radon: 'Monaspace Radon', monospace;
    --font-krypton: 'Monaspace Krypton', monospace;
}

.font-neon { font-family: var(--font-neon); }
```

#### Synthwave DOS Color Palette

Standard 8-color palette for all uDOS interfaces:

| Color  | Hex Code | CSS Variable | Usage                          |
|--------|----------|--------------|--------------------------------|
| Red    | #FF1744  | --udos-red   | Errors, critical alerts        |
| Green  | #00E676  | --udos-green | Success, confirmations         |
| Yellow | #FFEB3B  | --udos-yellow| Warnings, attention            |
| Blue   | #2196F3  | --udos-blue  | Information, links             |
| Purple | #E91E63  | --udos-purple| Highlights, special features   |
| Cyan   | #00E5FF  | --udos-cyan  | Active states, emphasis        |
| White  | #FFFFFF  | --udos-white | Primary text                   |
| Black  | #000000  | --udos-black | Backgrounds                    |
...
Five pre-built theme configurations:
...
<div class="udos-panel">
  ...
  <div class="panel-content">Panel body content</div>
</div>
```
...
Markdown-compatible panel syntax for embedding styled code blocks:
...
The `UDOSPanelSystem` JavaScript library automatically:
1. Finds all ` ```ucode` code blocks
2. Parses metadata from first line
...
Override theme colors and dimensions:
...
**Next**: See [Style Guide](Style-Guide.md) for complete design conventions and CSS frameworks.
