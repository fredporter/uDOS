...
- **[uCODE Syntax Quick Reference](uCODE-Syntax-Quick-Reference)** - Quick syntax
- **[Tutorial: uPY Quick Start](Tutorial-uPY-Quick-Start)** ⭐ - 15-minute beginner guide
- **[uPY Before & After](uPY-Before-After)** - Visual syntax comparison
- **[uPY Cheat Sheet](uPY-Cheat-Sheet)** - Quick reference
- **[Emoji Reference](Emoji-Reference)** - 80+ emoji codes
- **[Function Programming Guide](Function-Programming-Guide)** - Functions tutorial
- **[Adventure Scripting](Adventure-Scripting)** - Create text adventures
### Systems & Features
- **[Dashboard Guide](Dashboard-Guide)** - Web dashboard & mission control
- **[Knowledge System](Knowledge-System)** - 4-tier knowledge bank
- **[Mapping System](Mapping-System)** - Navigation & TILE codes
- **[Extensions System](Extensions-System)** - Using extensions
- **[Barter System](Barter-System)** - Economy & trade
- **[Variable System](Variable-System)** - System variables
- [Extensions System](Extensions-System) - Using extensions
...
## 🔧 Developer Resources
- **[Developers Guide](Developers-Guide)** - Complete developer documentation
- **[Architecture](Architecture)** - System design
- **[Extension Development](Extension-Development)** - Build extensions
- **[Style Guide](Style-Guide)** - Code & design standards
- **[Contributing](Contributing)** - How to contribute

### Content & Graphics
- **[Content Generation](Content-Generation)** - AI-assisted content creation
...
- **Survival** - Emergency skills & first aid
- **Productivity** - Time management & workflows
- **Well-Being** - Health & relationships
- **Skills** - Programming, writing, art, music
- **Environment** - Sustainability & gardening
- **Community** - Collaboration & mutual aid

**[Browse Knowledge →](../knowledge/README.md)**
...
- **[Extension Submissions](https://github.com/fredporter/uDOS/issues/new?template=extension_submission.md)**
...
- [GitHub Repo](https://github.com/fredporter/uDOS)
...
## 🤝 Community
- **[GitHub Discussions](https://github.com/fredporter/uDOS/discussions)** - Q&A & ideas
