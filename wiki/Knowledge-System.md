...
**Guide to the uDOS knowledge bank (v1.2.20)**

> **💡 Quick Start**: Access guides with `GUIDE <category>`, search with `GUIDE SEARCH <query>`, explore with `GUIDE LIST`
...
- **230+ Curated guides** in survival knowledge categories
- **Hierarchical organization** (water, fire, shelter, food, medical, etc.)
