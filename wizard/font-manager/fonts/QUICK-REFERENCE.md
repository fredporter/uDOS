...
**Version:** 1.0.0 | **Location:** `/wizard/font-manager/fonts/`
...
cd ~/uDOS/wizard/font-manager/fonts
./distribute.sh
...
```
/wizard/font-manager/fonts/          ← Central repository (source of truth)
...
```
1. Source: /wizard/font-manager/fonts/      (Central repository)
           ↓
...
```bash
cp /path/to/newfont.ttf /wizard/font-manager/fonts/category/
```
...
```bash
cd ~/uDOS/wizard/font-manager/fonts && ./distribute.sh
```
