...
1. [Location Mechanics](#location-mechanics)
2. [Map Mechanics](#map-mechanics)
3. [Cartography Roadmap](#cartography-roadmap)
4. [Base Map & Region Layouts](#base-map--region-layouts)
5. [Data Sharing Across Regions](#data-sharing-across-regions)
...
- **Fog**: Areas not yet explored or activated by the user.
