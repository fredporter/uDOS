...
# ═══════════════════════════════════════════════════════════════════════
# Fixes dataget validation issues and prevents legacy setup fallback
# ═══════════════════════════════════════════════════════════════════════
...
echo "y" | cmd_setup_user 2>&1 | grep -E "(✅|❌|⚠️|Template-based|Legacy)"
EOF

chmod +x /tmp/test-setup.sh
echo "   Testing main setup function..."

if /tmp/test-setup.sh | grep -q "Template-based setup completed successfully"; then
