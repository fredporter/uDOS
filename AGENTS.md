...
**Configuration:** `/public/wizard/config/wizard.json` (committed, versioned)
...
**Public (in `/public/extensions`):**

- `api/` - REST/WebSocket API server
- `transport/` - MeshCore, Audio, QR, NFC, Bluetooth transports
- `vscode/` - VS Code extension

**Wizard-only (in `/public/wizard/extensions`):**

- `assistant/` - AI services (Gemini, Vibe CLI, Ollama)
- `groovebox/` - Music production (MML, 808 drums)
...
> **📌 Note (2026-01-18):** Public code lives in `/public/` directory: `/public/extensions/` contains public plugins, `/public/wizard/extensions/` contains wizard-only features, `/public/distribution/` contains release artifacts. All code properly organized for open-source distribution.
