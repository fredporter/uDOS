...
export UDOS_ERROR_LOG_DIR="${UDOS_ROOT}/sandbox/logs/errors"
export UDOS_DEBUG_LOG_DIR="${UDOS_ROOT}/sandbox/logs/debug"
export UDOS_CRASH_LOG_DIR="${UDOS_ROOT}/sandbox/logs/crashes"
